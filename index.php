...
<head>
  ...
  <title>SMS Platform - Free mode</title>
    ...
    <div class="container-fluid">
      <div class="technology-use justify-content-start">
        ...
        <a class="navbar-brand " href="https://getbootstrap.com/">
          <i class="bi bi-bootstrap"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="Blue"
  ...
  <div class="container bg-body-secondary rounded-4 justify-content-center p-4 mt-5" style="width: 500px;">
    <div class="container">
      ...
      <h3 class="text-center">
        Send SMS World-Wide For Free
      </h3>
      <div class="mt-4">
        <label for="exampleFormControlInput1" class="form-label mb-1" style="margin-left: 20px;">Phone number: </label>
        <form class="row m-3 mt-0" action="index.php" method="post">
          <select class="rounded-left form-select" name="country" style="width: 100px;">
          ...
          <?php
          if (isset($_GET['phone'])) {
            $num = substr($_GET['phone'], 3);
            echo "<input type='text' class='form-control' value='$num' name='number' style='width: 150px;' id='number' placeholder='9123456789'>
              ";
          } else {
            echo "<input type='text' class='form-control' name='number' style='width: 150px;' id='number' placeholder='9123456789'>
              ";
          }
          ?>


          <label for="exampleFormControlInput1" class="form-label mt-2">Message: </label>
          <textarea class="form-control overflow-none" name="message"
            style="resize: none; max-width: 410px; min-height: 200px;" id="exampleFormControlTextarea1"
            rows="3"></textarea>

          <input type="submit" class="btn btn-success mt-3" name="" data-toggle="modal" data-target="#exampleModal"
            value="Send">
        </form>
      </div>
    </div>
