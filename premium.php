...
<head>
    ...
    <title>SMS Platform - Premium mode</title>
...
<body>
    ...
    <nav class="navbar sticky-top bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="balance-credit">
                <a href="/index.php" class="btn btn-outline-dark ">Free Mode</a>
    ...
    <div class="container bg-body-secondary rounded-4 justify-content-center p-4 mt-5" style="width: 500px;">
        <div class="container">
            ...
            <div class="mt-4">
                <label for="exampleFormControlInput1" class="form-label mb-1" style="margin-left: 20px;">Phone number:
                </label>
                <form class="row m-3 mt-0" action="premium.php" method="post">
              ...
              ";
                    ...
                    <input type="submit" class="btn btn-success mt-3" name="" data-toggle="modal"
                        data-target="#exampleModal" value="Send">
                </form>
            </div>
        </div>
    </div>
